...
boundings1, objs1 = read_obj(name = 'cube1', path = 'objs/cube1.obj',r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5,refraction = 0)
#1.0 1.0 1.0 0.3 0.7 0 0 5
...
for i, y in enumerate(np.linspace(screen[1], screen[3], height)):
  ...
  for j, x in enumerate(np.linspace(screen[0], screen[2], width)):
    ...
    for k in range(samples):
      ...
      color += trace_quadric(camera, origin, direction, objs, objs_wo_light, area_light, quadrics, all_boundings, max_depth = 5)
