...
boundings1, objs1 = read_obj(name = 'cube1', path = 'objs/cube1.obj',r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=1,n = 5,refraction = 1.33)
#1.0 1.0 1.0 0.3 0.7 0 0 5
...
#1.0 1.0 1.0 0.3 0.7 0 0 5
boundings7, objs7 = read_obj(name='back',path = 'objs/back.obj',r=0,g=0,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, refraction = 0)
