...
boundings1, objs1 = read_obj(name = 'cube1', path = 'objs/cube1.obj',
r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5,reflection = 0.5)

#1.0 1.0 1.0 0.3 0.7 0 0 5
boundings2, objs2 = read_obj(name = 'cube2', path = 'objs/cube2.obj',
r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0.5,n = 5,reflection = 0.5)

#1.0 1.0 1.0 0.3 0.7 0 0 5
boundings3, objs3 = read_obj(name = 'floor',path = 'objs/floor.obj',
r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, reflection = 0)

#1.0 1.0 1.0 0.3 0.7 0 0 5
boundings4, objs4 = read_obj(name = 'ceiling',path = 'objs/ceiling.obj',
r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, reflection = 0)

#1.0 0.0 0.0 0.3 0.7 0 0 5
boundings5, objs5 = read_obj(name = 'leftwall',path = 'objs/leftwall.obj',
r=1,g=0,b=0,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, reflection = 0)

#0.0 1.0 0.0 0.3 0.7 0 0 5
boundings6, objs6 = read_obj(name='rightwall',path = 'objs/rightwall.obj',
r=0,g=1,b=0,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, reflection = 0)

#1.0 1.0 1.0 0.3 0.7 0 0 5
boundings7, objs7 = read_obj(name='back',path = 'objs/back.obj',
r=1,g=1,b=1,ka=0.3,kd=0.7,ks=0,kt=0,n = 5, reflection = 0)
